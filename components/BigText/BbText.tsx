...
interface BbTextProps {
  slides: Array<string>
}

export default function BbText({ slides }: BbTextProps) {
  ...
  return (
    <div className='text-6xl md:text-9xl font-extrabold tracking-tight flex flex-col items-center'>
      <div className='flex flex-col items-center'>
        <p className='sm:text-3xl text-2xl tracking-normal'></p>
        ...
        <p className='mt-4 sm:text-3xl text-2xl tracking-normal'></p>
        <p className='mt-6 text-lg font-medium tracking-normal'></p>
      </div>
    </div>
  )
}
