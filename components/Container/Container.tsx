...
export default function Container(props: any) {
  ...
  return (
    <>
      ...
      >
        <Head>
          <meta name='Pandamania' content='follow, index' />
          <meta
            property='og:url'
          ...
          <meta property='og:site_name' content='Pandamania' />
        ...
        <nav className='sticky w-full bg-gray-100/40 z-[1] filter-blur dark:bg-gray-1000/40 top-2 md:top-4 max-w-2xl px-4 py-2 rounded-md mx-auto flex justify-between items-center'>
          <div className='flex flex-row gap-3 text-tertiary'>
            <Link href='/'>
            ...
            <Link href='https://panda-six-flame.vercel.app/'>
              <a className='hover:text-primary transition-all cursor-pointer'>
                Whitepaper
              </a>
            </Link>
